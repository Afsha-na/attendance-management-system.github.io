 ...
 <div class="container"><br>
          ...
          <div class="row">
            <div class="col-md-4 offset-md-4">
              <form  method="post" action="index.php?page=user_disable">
         ...
         <td> <?php echo ucwords($result['class'])?></td>
          ...
          <?php
           if($result['status']=="active"){?>
            <td>&nbsp;<button> <a class="btn btn-danger" name="disable" href="index.php?page=user_disable&get=<?php echo $result['id'] ?>">Disable</a></button></td>';
          ...
          <?php
           ...
           if($result['status']=="inactive"){?>
            <td>&nbsp;<button> <a class="btn btn-success" name="disable" href="index.php?page=user_disable&get=<?php echo $result['id'] ?>">Enable</a></button></td>';
            <?php
         }
          }
          ?>

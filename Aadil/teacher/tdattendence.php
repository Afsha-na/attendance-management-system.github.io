  ...
  <body>
    <div class="container"><br>
        ...
        <?php if (isset($_POST['showinfo'])) {
		  ...
		  $date=date('Y-m-d');
          if (!empty($choose)) {
            $query = mysqli_query($db_con,"SELECT * FROM `attendence` WHERE `date`='$date' AND `class`='$choose' AND `subject`='$subject';");?>
			
        <div class="row">
          <div class="col-sm-6 offset-sm-3">
            <table class="table  table-striped table-hover table-bordered" id="data">
  <thead class="thead-dark">
  <tr><td colspan="3"><h6 class="breadcrumb-item active" aria-current="page" align="right">Today:<?php echo date('Y-M-d') ?></h6></td>

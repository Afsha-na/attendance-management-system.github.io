...
<nav aria-label="breadcrumb">
  ...
  if ($corepage=='index.php') {?>
	 ...
	 ?>
     <!-- <li class="breadcrumb-item" aria-current="page"><a href="index.php">Dashboard </a></li> -->
     <li class="breadcrumb-item active" aria-current="page">Search Class Attendance</li>
  </ol>
</nav>
  <body>
...
<?php if (isset($_POST['showinfo'])) {
          ...
          if (!empty($choose && $choose)) {
                   $query = mysqli_query($db_con,"SELECT * FROM `attendence` WHERE  `subject`='$subject' AND `class`='$choose';");
                                   ...
                                   <div class="col-sm-6 offset-sm-3">
                                     <table class="table  table-striped table-hover table-bordered" id="data">
                                       <thead class="thead-dark">
                                        <tr><td colspan="3"><h6 class="breadcrumb-item active" aria-current="page" align="right">Semester:<?php echo $choose ?></h6></td>

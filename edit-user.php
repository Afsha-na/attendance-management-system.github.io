<?php 
  ...
  if (isset($_POST['userupdate'])) {
  	...
  	if (mysqli_query($db_con,$query)) {
  		...
  		echo "<script>window.location.href = 'index.php?page=user-profile&edit=success';</script>";
  	}else{
  		echo "<script>window.location.href = 'index.php?page=user-profile&edit=error';</script>";
  	}
  }
?>
